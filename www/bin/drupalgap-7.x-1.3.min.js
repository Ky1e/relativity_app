...
theme("logout"):"";case "title":return'<h1 id="'+system_title_block_id(drupalgap_path_get())+'" class="page-title"></h1>';case "powered_by":return'<p style="text-align: center;">'+t("Powered by")+": "+l("Relativity","http://jay-epstein.com/relativity/overview",{InAppBrowser:!0})+"</p>";case "help":return l("Help","http://www.drupalgap.org/support");default:return""}}catch(d){console.log("system_block_info - "+d)}}
